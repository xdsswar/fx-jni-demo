...
public class Demo extends Application {
    ...
    /**
     * JavaFX application entry point where the main window is initialized.
     */
    @Override
    public void start(Stage stage) {
        ...
        windowDecoration.setCornerPreference(CornerPreference.ROUND_SMALL);

        // Create a new scene and set it as the content of the stage with specified dimensions.
        Scene scene = new Scene(windowDecoration, 1000, 600);
